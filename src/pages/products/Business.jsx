...
import eduHeroImg from '../../assets/images/edu-hero.jpg';
import { CheckCircle, ArrowRight, Target, Lightbulb, BarChart3, ChevronDown } from 'lucide-react';

const Business = () => {
  const { t, i18n } = useTranslation();
  const challenges = t('products.business.challenges.items', { returnObjects: true });
  const differenceItems = t('products.business.difference.items', { returnObjects: true });
  const faqItems = t('products.business.faq', { returnObjects: true });
  const [openFaq, setOpenFaq] = useState(null);

  return (
    <>
      <SEOHead page="products-business" />
      ...
      <section className="relative bg-gradient-to-br from-dark-800 to-primary-800 text-white py-24 md:py-32">
        <div className="container-site">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-primary-200 font-semibold mb-2">{t('products.business.name')}</p>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6">
                {t('products.business.hero')}
              </h1>
              <p className="text-xl text-light-300 mb-8">
                {t('products.business.intro')}
              </p>
      ...
      <section className="section bg-white">
        <div className="container-site">
          <div className="text-center mb-12">
            <h2 className="section-title font-display">{t('products.business.challenges.title')}</h2>
          </div>
      ...
      <section className="section bg-light-200">
        <div className="container-site text-center max-w-3xl mx-auto">
          ...
          <h2 className="section-title font-display">{t('products.business.solution.title')}</h2>
          <p className="text-dark-600 text-lg leading-relaxed">
            {t('products.business.solution.description')}
          </p>
        </div>
      </section>
      ...
      <section className="section bg-white">
        <div className="container-site">
          <div className="text-center mb-12">
            <h2 className="section-title font-display">{t('products.business.difference.title')}</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
      ...
      <section className="section bg-light-200">
        <div className="container-site text-center max-w-3xl mx-auto">
          ...
          <h2 className="section-title font-display">{t('products.business.outcomes.title')}</h2>
          <p className="text-dark-600 text-lg leading-relaxed">
            {t('products.business.outcomes.description')}
          </p>
        </div>
      </section>
