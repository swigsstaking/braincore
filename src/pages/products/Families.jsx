...
const Families = () => {
  ...
  const challenges = t('products.families.challenges.items', { returnObjects: true });
  const differenceItems = t('products.families.difference.items', { returnObjects: true });
  const faqItems = t('products.families.faq', { returnObjects: true });
  const [openFaq, setOpenFaq] = useState(null);

  return (
    <>
      <SEOHead page="products-families" />

      {/* Hero */}
      <section className="relative bg-gradient-to-br from-dark-800 to-primary-800 text-white py-24 md:py-32">
        <div className="container-site">
          <div className="max-w-3xl">
            <p className="text-primary-200 font-semibold mb-2">{t('products.families.name')}</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6">
              {t('products.families.hero')}
            </h1>
            <p className="text-xl text-light-300 mb-8">
              {t('products.families.intro')}
            </p>
            <Link
      ...
      <section className="section bg-white">
        <div className="container-site">
          <div className="text-center mb-12">
            <h2 className="section-title font-display">{t('products.families.challenges.title')}</h2>
          </div>
      ...
      <section className="section bg-light-200">
        <div className="container-site text-center max-w-3xl mx-auto">
          ...
          <h2 className="section-title font-display">{t('products.families.solution.title')}</h2>
          <p className="text-dark-600 text-lg leading-relaxed">
            {t('products.families.solution.description')}
          </p>
        </div>
      </section>
      ...
      <section className="section bg-white">
        <div className="container-site">
          <div className="text-center mb-12">
            <h2 className="section-title font-display">{t('products.families.difference.title')}</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
      ...
      <section className="section bg-light-200">
        <div className="container-site text-center max-w-3xl mx-auto">
          ...
          <h2 className="section-title font-display">{t('products.families.outcomes.title')}</h2>
          <p className="text-dark-600 text-lg leading-relaxed">
            {t('products.families.outcomes.description')}
          </p>
        </div>
      </section>
